...
Want to see what the community has to offer? Check out the [Kometa Configs](https://github.com/kometa-team/Configs) repository on GitHub to see user-submitted configuration files, or even add your own to the mix!
