...
<sup>**3**</sup> You can use `current_year` to have Komet use the current years value. This can be combined with a `-#` at the end to subtract that number of years. i.e. `current_year-2`
