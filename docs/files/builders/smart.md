...
Reach out on the [Kometa Discord](https://kometa.wiki/en/latest/discord/) or in the [GitHub Discussions](https://github.com/kometa-Team/Kometa/discussions) for help if you're having any issues getting this to work properly.
