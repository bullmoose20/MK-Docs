...
!!! builder
    ...
    **[Plex (Smart)](../smart)** builders create Smart Collections based on the metadata inside your Plex Server. Results are dynamic and will update as your library updates without the need to re-run Komet.
    ...
    ??? quicklink "Popular Builders"
        ...
        - [:simple-plex: Smart Label](../smart/#smart-label) - Create a Smart Collection based on a specific label. The label can be generated by Komet based on criteria.
...
!!! builder
    ...
    **[Plex (Dumb)](../smart)** builders grab items based on the metadata inside your Plex Server. Results are static and require Komet to re-run to update.
