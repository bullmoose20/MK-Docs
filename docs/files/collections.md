...
Collection Files holds information on how Komet should create collections. There are a large number of 
...
Whenever I execute Komet and the Movies library is run, MyCollections.yml will run and my "Top 50 Grossing 
...
???+ example "Examples of Collection Operations"
    ...
    === "Example 1 - Sync Collection to List"
        ...
        1.  This is a Trakt List builder, telling Komet to build a collection based on the items in this list
    ...
    === "Example 3 - Add labels"
        ...
        1.  Tells Komet to not physically build a collection, but it will still perform the actions of the collection
...
In addition to manually defining each Collection that you want in your library, Komet can also dynamically 
