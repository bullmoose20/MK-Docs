...
Komet can dynamically create collections based on different criteria, such as
...
??? blank "`addons` - Used to define how multiple keys can be combined under a parent key.<a class="headerlink" href="#addons" title="Permanent link">¶</a>"
    ...
    **Accepted Values:** [Dictionary](../komet/yaml.md#dictionaries) where the key is the `dynamic key` and the value is a
...
??? blank "`template_variables` - Used to define template variables by key.<a class="headerlink" href="#template-variables" title="Permanent link">¶</a>"
    ...
    **Accepted Values:** [Dictionary](../komet/yaml.md#dictionaries) where the key is the template variable and the value 
    is another [Dictionary](../komet/yaml.md#dictionaries) where the key is the `dynamic key` of the collection you want 
...
??? blank "`key_name_override` - Used to override key names before being formatted into titles.<a class="headerlink" href="#key-name-override" title="Permanent link">¶</a>"
    ...
    **Accepted Values:** [Dictionary](../komet/yaml.md#dictionaries) where the key is the key name you want to change and 
...
??? blank "`title_override` - Used to override titles ignoring title formatting.<a class="headerlink" href="#title-override" title="Permanent link">¶</a>"
    ...
    **Accepted Values:** [Dictionary](../komet/yaml.md#dictionaries) where the key is the `dynamic key` you want to change 
